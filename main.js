const keyboardBtnsContainer = document.querySelector('.keyboard__btns');
let lang = "en";
...
if (lang === "en") {
    for (let i = 0; i < btnsEN.length; i++) {
        ...
        keyboardBtnsContainer.append(keyboardBtn);
        ...
        if (keyboardBtn.textContent === "CapsLock") {
            keyboardBtn.classList.add('keyboard__btn_wide');
            keyboardBtn.classList.add('caps-btn');
            // keyboardBtn.classList.add('akcent-btn');
        }

        if (keyboardBtn.textContent === "Enter") {
            keyboardBtn.classList.add('keyboard__btn_wide');
            keyboardBtn.classList.add('enter-btn');
            // keyboardBtn.classList.add('akcent-btn');
        }

        if (keyboardBtn.textContent === "Shift") {
            keyboardBtn.classList.add('keyboard__btn_wide');
            keyboardBtn.classList.add('shift-btn');
            // keyboardBtn.classList.add('akcent-btn');
        }
...
let keyboardBtns = document.querySelectorAll('.keyboard__btn');
